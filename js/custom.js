...
var totalQuestions = 12; // Update this to the total number of question containers
...
function showQuestion(questionNumber) {
    ...
    // Update the visibility of "Previous" and "Next" buttons based on the current question
    if (currentQuestion === 1) {
        $('#previousBtn').hide();
    } else {
        $('#previousBtn').show();
